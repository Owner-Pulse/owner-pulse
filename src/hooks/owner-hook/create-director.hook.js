...
import { createDirectorService } from "@/services/owner-service/create-director.service";
...
export const useGetDirectorActivity = (directorId, period = "all") => {
  const {
    data,
    ...
    queryKey: ["get-director-activity", directorId, period],
    queryFn: () => createDirectorService.getDirectorActivity(directorId, period, axiosInstance),
    enabled: !!directorId,
  });
