...
import EditPayrollScheduleModal from "@/pages/owner-dashboard/payroll/components/EditPayrollScheduleModal";
        ...
        <div className="px-6 py-4 border-b border-gray-100 flex justify-between items-center">
          <div>
            ...
            <p className="text-xs text-gray-400">
              View active payroll submission schedules for the academic / fiscal year.
            </p>
          </div>
        </div>
              ...
              {schedule.length === 0 && (
                <tr>
                  <td colSpan="7" className="py-8 text-center text-gray-400 text-xs">
                    No payroll periods scheduled. Click "Schedule Period" above to generate a cycle.
                  </td>
                </tr>
              )}
            </tbody>
...
export default DirectorPayrollScheduleTable;
