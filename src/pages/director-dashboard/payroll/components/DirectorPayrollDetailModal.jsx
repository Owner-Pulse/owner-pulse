...
import { useGetDirectorPayrollHistoryDetails } from "@/hooks/payroll/payroll.hook";
...
const DirectorPayrollDetailModal = ({ payroll, onClose }) => {
  const [activeTab, setActiveTab] = useState("all");

  if (!payroll) return null;

  // API query hook for Director history details
  const { historyDetails, isLoading } = useGetDirectorPayrollHistoryDetails(payroll?.id);
  const payload = historyDetails || payroll;
            ...
            <div className="flex items-center gap-3 mb-2">
              ...
              <div>
                <div className="flex items-center gap-2">
                  <h2 className="text-xl font-bold tracking-tight">Payroll Submission Details</h2>
          ...
          <div className="p-6 overflow-y-auto flex-1">
            {isLoading ? (
              <div className="flex flex-col items-center justify-center py-16 text-gray-500 gap-2">
                ...
                <p className="text-xs font-medium">Loading submission details...</p>
              </div>
            ) : activeTab === "notes" ? (
              /* Director Notes Tab */
...
export default DirectorPayrollDetailModal;
