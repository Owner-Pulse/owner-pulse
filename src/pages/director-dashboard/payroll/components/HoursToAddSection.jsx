      ...
      <Card className="bg-white border-none shadow-sm">
        <CardContent className="p-5">
          <SectionHeader number={5} title="Hours to Add (ADP)"
            ...
            onAdd={onAdd} addLabel="Add Hours" />
          <div className="space-y-2">
            ...
            {rows.map((row, i) => (
              <div key={row.id} className="grid gap-2 items-center" style={{ gridTemplateColumns: "1fr 70px 100px 28px" }}>
                ...
                <input type="number" value={row.hours} onChange={(e) => onUpdate(i, "hours", e.target.value)}
                ...
                <select value={row.type} onChange={(e) => onUpdate(i, "type", e.target.value)}
