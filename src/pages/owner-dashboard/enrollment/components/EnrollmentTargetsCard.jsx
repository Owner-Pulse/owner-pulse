    ...
    <CardContent>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {Object.values(targets).map((target) => {
          const hasTarget = (target.target ?? 0) > 0;
          const pct = hasTarget ? Math.round((target.actual / target.target) * 100) : 0;
