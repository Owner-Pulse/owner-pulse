      ...
      <CardContent>
        <div className="grid grid-cols-3 gap-3 mb-5">
          <div className="p-3 rounded-xl bg-gray-50 text-center">
            <p className="text-2xl font-extrabold text-cyan-600">{totalStudents}</p>
            <p className="text-[10px] text-gray-400 uppercase tracking-wider mt-1">Students</p>
          </div>
          <div className="p-3 rounded-xl bg-gray-50 text-center">
            <p className="text-2xl font-extrabold text-amber-600">{fmtMoneyShort(discountTotal)}</p>
            <p className="text-[10px] text-gray-400 uppercase tracking-wider mt-1">Per Month</p>
          </div>
          <div className="p-3 rounded-xl bg-gray-50 text-center">
            <p className="text-2xl font-extrabold text-amber-600">{fmtMoneyShort(discountTotal * 10)}</p>
